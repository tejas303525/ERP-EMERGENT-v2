        ...
        <div className="space-y-6 py-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select 
                value={form.sampling_size} 
                onValueChange={(v) => setForm({...form, sampling_size: v})}
              >
                <SelectTrigger>
                  <SelectValue placeholder="Select sampling size" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="small">Small (1-5%)</SelectItem>
                  <SelectItem value="medium">Medium (5-10%)</SelectItem>
                  <SelectItem value="large">Large (10-20%)</SelectItem>
          ...
          {inspection.items && inspection.items.length > 0 && (
            <div>
              ...
              <div className="border border-border rounded-md p-3 bg-muted/20 max-h-32 overflow-y-auto">
