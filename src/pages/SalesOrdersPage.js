          ...
          {selectedOrder && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div><span className="text-muted-foreground">Total Weight (MT):</span> <span className="font-mono">{selectedOrder.total_weight_mt?.toFixed(2) || '0.00'} MT</span></div>
                {selectedOrder.country_of_destination && (
                  <div><span className="text-muted-foreground">Country of Destination:</span> {selectedOrder.country_of_destination}</div>
                )}
              </div>
