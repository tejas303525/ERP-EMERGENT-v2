    ...
    <div className="page-container" data-testid="production-schedule-page">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
        ...
        <Card className="bg-red-500/10 border-red-500/30">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="kpi-value text-red-400">{schedule?.summary?.raw_materials_unavailable || 0}</p>
                <p className="kpi-label">Raw Materials Unavailable</p>
              </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="raw_materials_unavailable" data-testid="tab-raw-unavailable">
            <X className="w-4 h-4 mr-1" />
            Raw Materials Unavailable ({schedule?.raw_materials_unavailable?.length || 0})
          </TabsTrigger>
